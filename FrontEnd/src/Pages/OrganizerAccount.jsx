        ...
        <div className="flex min-h-screen w-full bg-white">
            ...
            <div className="flex flex-col justify-start p-8 md:p-12 lg:p-16 w-full md:w-1/2">
                ...
                <div className="mb-8 text-left">
                    ...
                    <h3 className="text-2xl font-bold text-gray-800">ZeeContest Organizer Account</h3>
                </div>
                ...
                <div className="w-full text-left">
                    {/* Organization Name */}
                    <div className="mb-6">
                        <label htmlFor="organizationName" className="block text-teal-800 font-medium mb-2">
                    ...
                    {/* Organization Email */}
                    <div className="mb-6">
                        <label htmlFor="organizationEmail" className="block text-teal-800 font-medium mb-2">
                            Organization Email
                        </label>
                        <input
                            type="email"
                    ...
                    {/* Password */}
                    <div className="mb-6">
                        <label htmlFor="password" className="block text-teal-800 font-medium mb-2">
                            Password
                        </label>
