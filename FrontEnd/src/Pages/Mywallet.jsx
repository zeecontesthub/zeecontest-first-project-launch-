            ...
            <div className="bg-gradient-to-br from-teal-600 to-teal-800 rounded-3xl p-8 text-white shadow-xl">
              ...
              <div className="flex items-center gap-4">
                <button
                  ...
                  className="bg-white text-teal-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors flex items-center gap-2 shadow-lg"
                >
                  <Settings className="w-4 h-4" />
                  Payout Settings
                </button>
                <button
                  className="bg-orange-500 text-white px-6 py-3 rounded-xl font-semibold hover:bg-orange-400 transition-colors flex items-center gap-2 shadow-lg"
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-left text-gray-600 mt-1">
                  Revenue breakdown from all your contests
                </p>
              </div>
          ...
          {selectedTab === "transactions" && (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                ...
                <p className="text-sm text-left text-gray-600 mt-1">
                  All voter payments and contest activities
                </p>
              </div>
