...
const CandidateLink = ({ open, onClose, link }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      <div
        ref={modalRef}
        className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-md mx-2 sm:mx-0 sm:mb-"
        style={{ minWidth: "0", width: "100%", maxWidth: "400px" }}
      >
        <h2 className="text-lg font-bold mb-4 text-gray-900 text-center">Share Contestant Link</h2>
        <div className="mb-4">
          <input
            type="text"
            value={link}
