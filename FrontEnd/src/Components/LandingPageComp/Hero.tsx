  ...
  return (
    ...
    >
      ...
      <main className='container mx-auto px-4 sm:px-6 lg:px-8 flex-1 flex flex-col justify-center'>
        ...
        >
          <h1 className='md:hidden block text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2'>
            Power Your Contests with Seamless Online Voting
          </h1>
          <h1 className='hidden md:block text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2'>
            Power Your Contests with
            <br /> Seamless Online Voting
          </h1>
          <p className='text-base sm:text-lg lg:text-xl text-white/90 max-w-sm lg:max-w-2xl mx-auto leading-relaxed px-4'>
