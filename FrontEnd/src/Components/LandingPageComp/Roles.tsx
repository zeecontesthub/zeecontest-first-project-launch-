  ...
  return (
    <div className='my-12 px-4 md:px-12 xl:px-32 md:mt-24'>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <h1 className='text-[#1D1D1D] font-semibold text-4xl md:text-5xl leading-tight mb-1 md:mb-2'>
          Everyone has a
        </h1>
        <h1 className='text-[#1D1D1D] font-semibold text-4xl md:text-5xl leading-tight'>
