...
const ContestantDetailsStep = ({
    ...
    return (
        <div className="space-y-8 bg-[#FBF7F7] p-10">
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex-1 px-4 py-3 bg-gray-50 border border-gray-200 rounded-md text-gray-500">
                                {contestantForm.image ? contestantForm.image.name : 'No file selected'}
                            </div>
                            <button
                                onClick={() => document.getElementById('contestant-image-input').click()}
            ...
            {/* Bulk Upload */}
            <div>
                <h2 className="text-xl font-semibold text-left text-gray-900 mb-6">Bulk Upload</h2>
            ...
            {/* Contestant List */}
            <div>
                <h2 className="text-xl font-semibold text-left text-gray-900 mb-6">Contestant List</h2>
                        ...
                        <div className="divide-y divide-gray-200">
                            {contestants.map((contestant) => (
                                <div key={contestant.id} className="grid grid-cols-5 gap-4 px-6 py-4 text-sm items-center">
                                    ...
                                    <div className="text-gray-900 font-medium">{contestant.name}</div>
          ...
          >
            ...
            <div className="space-y-2 sm:space-y-1">
              <p className="text-sm sm:text-base text-gray-600">
                <span className="hidden sm:inline">Drag and Drop your CSV file here</span>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center mt-1 text-sm text-gray-500">
                              ...
                              <span className="truncate">{contestant.position}</span>
                            </div>
                            {contestant.email && (
                              <div className="flex items-center mt-1 text-sm text-gray-500">
