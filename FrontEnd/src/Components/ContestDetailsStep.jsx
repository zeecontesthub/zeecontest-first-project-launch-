...
const ContestDetailsStep = ({ formData, onInputChange, positions, onAddPosition, onUpdatePosition, onRemovePosition }) => {
                            ...
                            <div>
                                ...
                                <div className="flex space-x-2">
                                    <select
                                        ...
                                        onChange={(e) => onInputChange('startTimeHour', e.target.value)}
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => onInputChange('startTimeMinute', e.target.value)}
                                        className="w-16 px-2 py-3 bg-gray-50 border border-gray-200 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors"
                                    >
                                    ...
                                    <select
                                        value={formData.startTimeAmPm || 'AM'}
                                        onChange={(e) => onInputChange('startTimeAmPm', e.target.value)}
                            ...
                            <div>
                                ...
                                <div className="flex space-x-2">
                                    <select
                                        ...
                                        onChange={(e) => onInputChange('endTimeHour', e.target.value)}
                                        className="w-16 px-2 py-3 bg-gray-50 border border-gray-200 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors"
                                    >
                                        <option value="">HH</option>
                                        {[...Array(12)].map((_, i) => {
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => onInputChange('endTimeMinute', e.target.value)}
                                        className="w-16 px-2 py-3 bg-gray-50 border border-gray-200 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors"
                                    >
                                        <option value="">MM</option>
                                        {[...Array(60)].map((_, i) => {
                                    ...
                                    <select
                                        value={formData.endTimeAmPm || 'AM'}
                                        onChange={(e) => onInputChange('endTimeAmPm', e.target.value)}
                                        className="w-20 px-2 py-3 bg-gray-50 border border-gray-200 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors"
                                    >
                                        <option value="AM">AM</option>
                                        <option value="PM">PM</option>
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-200">
                            {positions.map((position, index) => (
                                <div key={index} className="grid grid-cols-3 gap-4 px-6 py-4 text-sm items-center">
                                    {editIndex === index ? (
                                        <>
                                            <input
                                                type="text"
